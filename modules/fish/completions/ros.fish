...
# complete -c ros -n '__fish_seen_subcommand_from run' -s "sp" -d 'combination of -s SP and -p SP'
...
# complete -c ros -n '__fish_seen_subcommand_from run' -s "ip" -d 'evaluate and princ FORM after restart'
complete -c ros -n '__fish_seen_subcommand_from run' -l print -d 'evaluate and princ FORM after restart'
# complete -c ros -n '__fish_seen_subcommand_from run' -s "iw" -d 'evaluate and write FORM after restart'
...
# complete -c ros -n '__fish_seen_subcommand_from run' -s "+R" -d 'skip /etc/rosrc, ~/.roswell/init.lisp'
...
# complete -c ros -n '__fish_seen_subcommand_from run' -s "+Q" -d 'do not use quicklisp'
