# fish completion for rain                                 -*- shell-script -*-
...
# this function limits calls to __rain_perform_completion, by caching the result behind $__rain_perform_completion_once_result
...
# this function is used to clear the $__rain_perform_completion_once_result variable after completions are run
...
# - Obtain the completions and store them in the global __rain_comp_results
...
# this will get called after the two calls below and clear the $__rain_perform_completion_once_result global
complete -c rain -n '__rain_clear_perform_completion_once_result'
# The call to __rain_prepare_completions will setup __rain_comp_results
